...
- 链接到其他站点：\[示例]\(www.example.com)
  ...
  | **正例**                                                    | **反例**                                               |
  | ----------------------------------------------------------- | ------------------------------------------------------ |
  | 请参见\[openJiuwen开源项目](https://gitcode.com/openjiuwen) | openJiuwen开源项目请参见https://gitcode.com/openjiuwen |
...
| **正例**                                                     | **反例**                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| - Agent development framework (ADF)；智能体开发框架<br>用于提供统一的低码、高码等Agent开发、管理能力的框架。 | - ADF<br>Agent development framework，智能体开发框架，用于提供统一的低码、高码等Agent开发、管理能力的框架。 |

【建议】一篇文档中某缩略语首次出现的位置（标题和表头除外），提供英文全称，可选提供中文全称。

【建议】组件名称、Agent应用名称等不作为术语或缩略语，不在术语表中体现。建议在文档中单独以表格或其他形式介绍。
